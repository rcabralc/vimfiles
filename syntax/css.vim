...
syn cluster cssValues contains=cssAttr,cssColor,cssImportant,cssNumber,cssUnits,cssQuote,cssFunction

syn region cssAtValBlock start=/:\zs/ end=/\ze[)]/ contained contains=@cssValues
...
syn match cssUnits /\v(\d)@<=(\%|cm|deg|dpi|dpcm|em|ex|in|mm|pc|pt|px|s)\ze\s*[,;)}]*/ contained
